...
public class LabirintoBuilderTestGithub {
	...
	public void testTrilocaleConStanzaDuplicata() {
				...
				.getLabirinto();
		assertTrue(labirintoBuilder.getMapStanze().size()<=2);
	}
	...
	public void testAggiuntaAttrezziAStanze_AppenaAggiunte() {
		...
		labirintoBuilder
				...
				.addAttrezzo(nomeAttrezzo, peso)
				.getLabirinto();
		assertTrue(this.labirintoBuilder.getMapStanze().get(nomeStanza).getAttrezzi().contains(new Attrezzo (nomeAttrezzo,peso)));
	...
	public void testAggiuntaAttrezzoAStanze_AppenaAggiunteMultiple() {
		...
		this.labirintoBuilder
				...
				.getLabirinto();
		Attrezzo attrezzo = new Attrezzo(nomeAttrezzo,peso);
		List<Attrezzo> attrezzi = labirintoBuilder.getMapStanze().get(nomeStanza).getAttrezzi();
	...
	public void testLabirintoConStanzaBloccata_ConPassepartout() {
		...
		assertEquals(stanzaVincente.getNome(),labirintoBuilder.getMapStanze().get("stanza bloccata").getStanzaAdiacente(Direzione.NORD).getNome());	
	}
	...
	public void testLabirintoConStanzaBloccata_SenzaPassepartout() {
		...
		assertEquals(stanzaBloccata.getNome(),labirintoBuilder.getMapStanze().get("stanza bloccata").getStanzaAdiacente(Direzione.NORD).getNome());
	}
